...
timeout 355m srun -N 1 -n 1 -c 40 julia --project=.. --threads 1 --check-bounds=no sr_tet/sr_mtc.jl &
timeout 355m srun -N 1 -n 1 -c 40 julia --project=.. --threads 1 --check-bounds=no sr_tet/sr_mtu.jl &
timeout 355m srun -N 1 -n 1 -c 40 julia --project=.. --threads 1 --check-bounds=no sr_tet/sr_ntc.jl &
timeout 355m srun -N 1 -n 1 -c 40 julia --project=.. --threads 1 --check-bounds=no sr_tet/sr_ntu.jl &
wait
