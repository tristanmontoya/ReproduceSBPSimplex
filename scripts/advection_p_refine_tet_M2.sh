...
timeout 1410m srun -N 1 -n 1 -c 40 julia --project=.. --threads 40 --check-bounds=no p_refine_tet/advtetmtuM2.jl &
timeout 1410m srun -N 1 -n 1 -c 40 julia --project=.. --threads 40 --check-bounds=no p_refine_tet/advtetmtcM2.jl &
wait
